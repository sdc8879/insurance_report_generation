module.exports.dailyQuery = function () {
    var dailyQueryString = `SELECT CONCAT(INSURANCE_TRANSACTIONS.MD_TITLE,' ',
...
(SELECT IP_PRODUCTS.IP_TITLE FROM IP_PRODUCTS WHERE IP_ID=INSURANCE_TRANSACTIONS.IP_ID ))AS POLICY_DETAILS,
    ...
    WHEN INSURANCE_TRANSACTIONS.POLICY_STATUS IS NOT NULL THEN 'Not Pushed'
    ...
    WHERE INSURANCE_TRANSACTIONS.CREATED_TIME BETWEEN CURDATE()-1 AND CURDATE()
    AND IP_PAYMENT_TRANSACTION.PAYMENT_STATUS=1
    ORDER BY INSURANCE_TRANSACTIONS.CREATED_TIME DESC;`
    //WHERE INSURANCE_TRANSACTIONS.CREATED_TIME BETWEEN '2016-11-17 ' AND '2016-11-30';`
    // WHERE INSURANCE_TRANSACTIONS.CREATED_TIME BETWEEN CURDATE()-1 AND CURDATE();
    // `;
